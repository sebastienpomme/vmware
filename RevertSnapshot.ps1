...
# Example : .\RevertSnapshot.ps1 -vmname VM01 -snapname name_of_snapshot -cluster *
# Example : .\RevertSnapshot.ps1 -vmname * -snapname name_of_snapshot -cluster * >> Snapshot's name should be the same for all vm!
